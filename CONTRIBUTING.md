...
[![GitHub](https://img.shields.io/badge/GitHub-Contribute-green.svg)](https://github.com/linxiong-rgb/flask-blog)
...
| 类型 | 说明 | 示例 |
|:---:|:-----|:-----|
| **🐛 Bug 报告** | 发现并报告问题 | 功能异常、显示错误 |
| **✨ 功能建议** | 提出新功能或改进建议 | 新增功能、优化体验 |
| **💻 代码贡献** | 修复 Bug 或实现新功能 | PR 代码提交 |
| **📖 文档改进** | 完善项目文档 | 补充说明、修正错误 |
| **👀 代码审查** | 帮助审查他人的 PR | 检查代码、提出建议 |
| **🧪 测试** | 编写和运行测试 | 发现边界问题 |
| **📢 分享** | 向他人推荐本项目 | 社交媒体、技术博客 |
...
| 前缀 | 用途 | 示例 |
|:---:|:-----|:-----|
| `feature/` | 新功能 | `feature/gallery-upload` |
| `fix/` | Bug 修复 | `fix/image-load-error` |
| `docs/` | 文档更新 | `docs/api-guide` |
| `refactor/` | 代码重构 | `refactor/user-model` |
| `test/` | 测试相关 | `test/image-upload` |
| `style/` | 代码格式 | `style/code-format` |
...
2. **及时响应**：关注 PR 的审查意见
3. **保持更新**：及时同步上游代码
4. **关闭 Issue**：PR 合并后，关联的 Issue 会自动关闭
